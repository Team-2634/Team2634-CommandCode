...
public class sub_SwerveDrive extends SubsystemBase {
  ...
  SwerveModulePosition[] test = new SwerveModuleState()

  private final AHRS navx = new AHRS(SPI.Port.kMXP);
  private final SwerveDriveOdometry odometer = new SwerveDriveOdometry(DriveConstants.kDriveKinematics, new Rotation2d(0), backRight.getState());
